  ...
  <main class=" w-full p-6 ">
        ...
        <div class="  rounded-lg ">
            <div class=" max-w-full mx-auto p-6">
                <h1 class="text-3xl font-bold text-center text-white mb-4">Category</h1>

                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onclick="showPopup('add')">Add </button>
...
<input type="text" id="search" onkeyup="liveSearch()" placeholder="Search by category" class="border rounded p-2 mb-4">

<table class="w-full bg-white border justify-center text-center">
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td class='px-4 py-2'>
                <a href='javascript:void(0)' onclick='showEditPopup(".$row['id'].", \"".$row['name']."\")' class='text-green-400'>Edit</a> | 
                <a href='category.php?deleteId=".$row['id']."'onclick=\"return confirm('Are you sure you want to delete?')\" class='text-red-600'>Delete</a>
              </td>";
        echo "</tr>";
    }
    ?>
