...
<nav class="bg-white p-4 shadow-md">
    <div class="container mx-auto flex justify-between items-center">
      <a href="#" class="text-2xl font-bold text-green-600 italic">QuickFixPro</a>
      <ul class="flex space-x-6">
        <li x-data="{ open: false }" class="relative">
          ...
          <ul x-show="open" @click.away="open = false" class="absolute z-10 right-0 mt-2 py-2 w-40 bg-white border rounded-lg shadow-md">
            <li><a href="profile.php" class="block px-4 py-2 text-gray-700 hover:bg-green-100">Profile</a></li>
